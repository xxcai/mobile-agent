...
脚本行为:
  1. 构建 :agent-core 和 :agent-android 的 debug AAR
...
常见命令:
  ...
  CORE_ASSET_NAME=agent-core-demo.aar ANDROID_ASSET_NAME=agent-android-demo.aar ./scripts/release-assets.sh v0.1.0-demo your-org/mobile-agent
EOF
}
