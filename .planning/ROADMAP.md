...
- ⏳ **v2.10 响应卡片改版** — Phases 1-4 (planned)
...
<details>
<summary>⏳ v2.10 响应卡片改版 (Phases 1-4) — PLANNED</summary>

- [x] Phase 1: 响应卡片数据结构 (P0) — 大卡片布局
  - [ ] v2.10-01-01-PLAN.md — 响应卡片统一为大卡片布局 (RESP-01)
  - [ ] v2.10-01-02-PLAN.md — 工具区按需显示 (RESP-02)
  - [ ] v2.10-01-03-PLAN.md — think区按需显示 (RESP-03)
  - [ ] v2.10-01-04-PLAN.md — 正文区 Markdown 支持 (RESP-04)

- [ ] Phase 2: 流式文本处理 (P0) — think块解析与展示
  - [ ] v2.10-02-01-PLAN.md — 解析 onTextDelta 判断 think 块 (STREAM-01)
  - [ ] v2.10-02-02-PLAN.md — think 内容增量追加 (STREAM-02)
  - [ ] v2.10-02-03-PLAN.md — 正文内容增量追加 (STREAM-03)

- [ ] Phase 3: 工具调用状态 (P0) — 工具状态展示
  - [ ] v2.10-03-01-PLAN.md — onToolUse 展示工具 (TOOL-01)
  - [ ] v2.10-03-02-PLAN.md — onToolResult 标记完成 (TOOL-02)

- [ ] Phase 4: 状态管理与测试 (P1) — 状态转换与整合
  - [ ] v2.10-04-01-PLAN.md — 状态转换逻辑 (STATE-01, STATE-02)
  - [ ] v2.10-04-02-PLAN.md — 整合测试

**Requirements:**
- Phase 1: RESP-01, RESP-02, RESP-03, RESP-04 ⏳
- Phase 2: STREAM-01, STREAM-02, STREAM-03 ⏳
- Phase 3: TOOL-01, TOOL-02 ⏳
- Phase 4: STATE-01, STATE-02 ⏳
